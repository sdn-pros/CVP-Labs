...
| --------- | --------------- | ------------ | --------- |
| rack2 | Vlan4094 | 10.255.252.4 | Port-Channel1 |
...
| Ethernet6 | host2_Eth3 | *access | *110 | *- | *- | 6 |
| Ethernet7 | host2_Eth4 | *access | *110 | *- | *- | 6 |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 192.168.101.4:10 | 10:10 | - | - | learned | 110 |
| Tenant_A_VMOTION | 192.168.101.4:55160 | 55160:55160 | - | - | learned | 160 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_OP_Zone | 192.168.101.4:10 | connected |
