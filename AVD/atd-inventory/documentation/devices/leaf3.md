...
| --------- | --------------- | ------------ | --------- |
| rack2 | Vlan4094 | 10.255.252.5 | Port-Channel1 |
...
| Ethernet6 | host2_Eth1 | *access | *110 | *- | *- | 6 |
| Ethernet7 | host2_Eth2 | *access | *110 | *- | *- | 6 |
...
| Port-Channel6 | host2_PortChanne1 | switched | access | 110 | - | - | - | - | 6 | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 192.168.101.3:10 | 10:10 | - | - | learned | 110 |
| Tenant_A_VMOTION | 192.168.101.3:55160 | 55160:55160 | - | - | learned | 160 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_OP_Zone | 192.168.101.3:10 | connected |
