...
| --------- | --------------- | ------------ | --------- |
| rack1 | Vlan4094 | 10.255.252.1 | Port-Channel1 |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 192.168.101.1:10 | 10:10 | - | - | learned | 110 |
| Tenant_A_VMOTION | 192.168.101.1:55160 | 55160:55160 | - | - | learned | 160 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_OP_Zone | 192.168.101.1:10 | connected |
